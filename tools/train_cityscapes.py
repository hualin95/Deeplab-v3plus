...
arg_parser.add_argument('--data_root_path', default="/data/linhua/VOCdevkit/", help="the root path of dataset")
arg_parser.add_argument('--imagenet_pretrained', type=str2bool, default=True,
                        help="whether apply iamgenet pretrained weights")
arg_parser.add_argument('--store_result_mask', type=str2bool, default=True, help="whether store mask after val or test")
arg_parser.add_argument('--result_filepath', default="/data/linhua/VOCdevkit/VOC2012/Results/",
                        help="the filepath where mask store")
arg_parser.add_argument('--loss_weight', type=str2bool, default=False, help="whether apply weights of loss")

arg_parser.add_argument('--checkpoint_dir', default=os.path.abspath('..')+"/checkpoints/")
arg_parser.add_argument('--saved_checkpoint_file', help="the filename of saved checkpoint ")
arg_parser.add_argument('--pretrained', type=str2bool, default=False, help="whether apply pretrained checkpoint")
arg_parser.add_argument('--store_checkpoint_name', default="voc2012_no_class_weight_sync_bn_26",
                        help="the filename of checkpoint to store")
...
arg_parser.add_argument('--lr', type=float, default=0.007, help="init learning rate ")
arg_parser.add_argument('--iter_max', type=int, default=30000, help="the maxinum of iteration")
    ...
    def validate(self):
        ...
        with torch.no_grad():
            ...
            for x, y, id in tqdm_batch:
                ...
                # if self.args.store_result_mask == True and self.current_epoch == 20:
